...
- **Tiga varian spektrum** mengikuti tema: `segment` (blok bertumpuk dengan segmen mati yang tetap samar, Kaca asap), `bar` (batang bergradasi, Kokpit kaca), dan `soft` (satu kurva terisi, Deck malam). Semuanya memakai peran warna, bukan warna mentah, dan peak-hold digambar sebagai garis tipis.
